...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ProjectOne", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ProjectOne", null, 1700, 900);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ProjectOne";
		app.meta["name"] = "ProjectOne";
